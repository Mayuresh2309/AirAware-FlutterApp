...
class Modal1 extends StatefulWidget {
  final dynamic data;

  const Modal1({Key? key, required this.data}) : super(key: key);

  @override
  State<Modal1> createState() => _Modal1State();
}

class _Modal1State extends State<Modal1> with TickerProviderStateMixin {
  double? maxY;
  double? stepValue;
          ...
          children: [
            ...
            Container(
              ...
              child: ListView(
                ...
                children: widget.data['pollutants'].entries.map<Widget>((entry) {
                  return Row(
                    children: [
                      Card(
